function QRegister(config) {
    ...
    this.tips = {
        ...
        captchaEmpty: 'Verification code cannot be empty',
        ...
        pwdNotSame: 'The password you entered two times is not consistent',
        emailEmpty: 'Please enter the mailbox',
        emailInvalid: 'Please enter the correct mailbox',
        emailNotSupport: 'The mailbox suffix is not supported',
